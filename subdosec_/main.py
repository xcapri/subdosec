...
def analyze_target(target, mode, apikey, output_scan, host_scan, fingerprints, vuln_only, pe):
...
def scan_by_web(mode, vuln_only, pe):
    ...
    try:
        ...
        for target in targets:
            analyze_target(target, mode, apikey, output_scan, host_scan, fingerprints, vuln_only, pe)
